...
// 8Ә сыныбының 23 оқушысы (Screenshot_20260612_011839.png бойынша)
const KZ_NAMES = [
  'Алима Ерболқызы', 'Бекзат Мақсат', 'Мөлдір Нұржанқызы', 'Асылхан Дәурен',
  'Жансая Қуанышқызы', 'Ислам Арман', 'Айкөркем Саматқызы', 'Нұрдәулет Сәкен',
  'Әсем Ербебұланқызы', 'Дінмұхаммед Талғат', 'Мадина Ерланқызы', 'Еркежан Болатқызы',
  'Данияр Руслан', 'Ақниет Серікқызы', 'Олжас Қайыржан', 'Гүлназ Асқарқызы',
  'Темірлан Мұрат', 'Аружан Нұрланқызы', 'Қайсар Әділ', 'Меруерт Бексатқызы',
  'Сұлтан Данияр', 'Жібек Қанатқызы', 'Ерсұлтан Алмас'
];
...
const KZ_CITIES = ['Қарағанды'];
const SCHOOLS = ['103 Ә.Ермеков атындағы мектеп лицейі'];
const GRADES = ['8Ә'];
...
async function run() {
  ...
  console.log('   student1@edu.kz … student23@edu.kz / student123');
